...
class Contentprint {
  ...
  Contentprint({
    ...
    this.content,
    this.align,
    this.size = PrintSize.medium,
    this.imagePath,
  }) : assert(
         type != PrintType.text ||
             (content is String && align is PrintAlign && size is PrintSize),
  ...
  String _formatContent() {
    if (type == PrintType.image || content == null || size == null)
      return content ?? '';
  ...
  static Contentprint fromJson(Map<String, dynamic> json) {
    return Contentprint(
      ...
      align:
          json['align'] != null
              ? PrintAlign.values.firstWhere((e) => e.name == json['align'])
              : null,
